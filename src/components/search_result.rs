...
//     states::Action,
//     store::{owned_iter::OwnedUtxoIter, rocks_db_switch::RocksDBSwitch},
...
//             search_type,
//             query,
//             list: ListComponent::from_iter(Entity::UTXOs, Box::new(iter::empty())),
...
//             self.list = ListComponent::from_iter(Entity::UTXOs, self.search_result_iter());
//         }
//         Ok(vec![])
//     }
